...
🔓 <a href="https://coinmarketcap.com/ru/token-unlocks/">Важные разблокировки</a>
(оставь пустым, только этот заголовок — я смотрю таблицу сам)
...
(оставь пустым, только этот заголовок — я заполняю сам)
 ...
 BTC и ETH:
(оставь пустым, только этот заголовок — я заполняю сам; сюда я буду руками добавлять уровни/мысли по биткоину и эфиру)

📅 <a href="https://tradingeconomics.com/calendar">Календарь на сегодня</a>
